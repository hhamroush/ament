...
//                 <ul className="mainHeaderAbout">
//                     <li>
//                     <div className="icon">
//                         <span className="icon-pin" />
//                     </div>
//                     <div className="text">
//                         <p>3-5 Mousadak Street El Nahda Tower - 12th &amp; 13th floor</p>
//                     </div>
//                     </li>
//                     <li>
//                     <div className="icon">
...
//                     <div className="text">
//                         <p>
//                         <a href="https://makhzankey.com/ament/language?lang=ar"> عربي</a>
//                         </p>
//                     </div>
//                     </li>
//                 </ul>
//                 <div className="mainHeaderSocials">
...
//                     </a>
//                     <a href="https://api.whatsapp.com/send?phone=+20111111" target="_blank">
      ...
      <nav className="mx-auto flex w-100 items-center justify-between p-6 lg:px-8 text-white bg-black" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-8 w-auto" src="../images/logo-1.png" alt="" />
          </a>
        </div>
